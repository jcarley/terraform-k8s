...
resource "aws_security_group_rule" "master_ingress_heapster_from_node" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.master.id}"
...
resource "aws_security_group_rule" "master_ingress_flannel_from_node" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.master.id}"
  source_security_group_id = "${aws_security_group.node.id}"
...
resource "aws_security_group_rule" "master_ingress_node_exporter_from_node" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.master.id}"
  source_security_group_id = "${aws_security_group.node.id}"
...
resource "aws_security_group_rule" "master_ingress_kubelet_insecure_from_node" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.master.id}"
  source_security_group_id = "${aws_security_group.node.id}"
...
resource "aws_security_group_rule" "master_ingress_kubelet_secure_from_node" {
  type                     = "ingress"
  security_group_id        = "${aws_security_group.master.id}"
  source_security_group_id = "${aws_security_group.node.id}"
